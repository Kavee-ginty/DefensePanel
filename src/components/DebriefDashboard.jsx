      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="flex flex-wrap justify-center gap-3 pb-8">
          <button
            type="button"
            onClick={() => onReturn?.()}
            className="rounded-xl bg-blue-600 px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
          >
            Return to Lobby
          </button>
          <button
            type="button"
            onClick={() => onGoHistory?.()}
            className="rounded-xl border border-slate-600 bg-transparent px-8 py-3 text-sm font-medium text-slate-100 transition-colors hover:border-slate-400 hover:bg-slate-900/60 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
          >
            Session History
          </button>
        </div>
